...
const createConnection = async () => {
  ...
  if (
    ...
    axios
      .post("http://localhost:6060/v1/api/connections", modified_connection.value)
      .then((res) => {
        if (res.status == 200) {
...
const updateConnection = async () => {
  ...
  if (
    ...
    if (modified_connection.value.calendarName == "")
      modified_connection.value.calendarName = modified_connection.value.database.name;
    axios
      .patch("http://localhost:6060/v1/api/connections", modified_connection.value)
      .then((res) => {
...
const deleteConnection = async () => {
  axios
    .delete("http://localhost:6060/v1/api/connections", {
      data: {
